// src/pages/Consultor/ConsultorLogin.tsx
    ...
    try {
      ...
      if (!res.ok) {
        ...
        try {
          ...
          if (errJson?.message) {
            detail = Array.isArray(errJson.message)
              ? errJson.message[0]
              : errJson.message;
          }
        } catch {}
      ...
      navigate("/consultor"); // 👈 redireciona para área do consultor
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-lg w-96">
        <h2 className="text-2xl font-bold text-center mb-6">Login Consultor</h2>
